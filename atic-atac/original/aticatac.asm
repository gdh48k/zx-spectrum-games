...
panel_chars:    db  0, 0, 0, 0, 0, 0, 0, 0    ; 0
                ...
                db  &80, &c1, &ff, &7f, &80, &ff, &7f, &3e; &0170 ;BOTTOM ROSETTE DATA
...
knight_chars:   db  0,  0,  &60,  &E2,  &A7,  &3B,  &71,  &F2; &0278 START OF LETTERING
                ...
                db  &fe, &fe, &fe, &38, &38, &38, &38, 0; &02c8 T?
                db  &7C,  &FE,  &F0,  &7C,  &1E,  &FE,  &7C,  &0
                ;db  &7c, &7c, &38, &38, &38, &7c, &7c, 0; &02d0 I? 
                db  &82, &ee, &fe, &fe, &d6, &d6, &d6, 0; &02d8 M?
                db  &f8, &f8, &e0, &fc, &e0, &fe, &fe, 0; &02e0 E?
